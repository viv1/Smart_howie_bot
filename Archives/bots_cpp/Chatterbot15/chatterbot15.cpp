//
// Program Name: Chatterbot15
// Chatterbot introduces a a procedure for saving unknown found during a chat session with the user
//
// Author: Gonzales Cenelia
//

#include "chatterbot15.h"
...
int main()
{
	std::cout << "Chatterbot v15.0 Copyright (C) 2010 Gonzales Cenelia\n" << std::endl;
	try 
	{
		CBot bot("Chatterbot15");
