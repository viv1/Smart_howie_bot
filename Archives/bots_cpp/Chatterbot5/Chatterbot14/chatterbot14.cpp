//
// Program Name: Chatterbot14
// Chatterbot introduces a better repetition handling algorithm, handles long term repetition 
// made by the chatterbot during the chating sesssion
//
// Author: Gonzales Cenelia
//

#include "chatterbot14.h"
...
int main()
{
	std::cout << "Chatterbot v14.0 Copyright (C) 2010 Gonzales Cenelia\n" << std::endl;
	try 
	{
